...
import me.syrin.monopolis.common.game.tiles.CardDraw
import kotlin.math.abs

class CardDrawDrawable(val reference: CardDraw, val rotation: Int) : Drawable() {
    ...
    override fun draw(canvas: Canvas) {
        ...
        // TODO: Draw image for ChanceA,B,C and CommunityChest
    }
